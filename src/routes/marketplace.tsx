    ...
    queryFn: async (): Promise<Product[]> => {
      ...
      if (dbError || !data || data.length === 0) {
        return [
          {
            id: "fallback-1",
            name: "Imperial Rose Gold Tourbillon",
            description:
              "A masterclass in haute horlogerie. Sapphire caseback and alligator strap.",
            category: "Horology",
            price_cents: 25000000, // $250k
            currency: "USD",
            stock: 2,
            featured: true,
          ...
          {
            id: "fallback-2",
            name: "L'Essence 1982 Vintage Cognac",
            description: "Aged to perfection in French oak casks. Bottled in crystal decanter.",
            category: "Spirits",
            price_cents: 850000, // $8.5k
            currency: "USD",
            stock: 5,
            featured: true,
          ...
          {
            id: "fallback-3",
            name: "Sovereign AI Automation Node",
            description: "Enterprise-grade local LLM deployment with custom neural routing.",
            category: "Automation",
            price_cents: 12500000, // $125k
            currency: "USD",
            stock: 1,
            featured: true,
          ...
          {
            id: "fallback-4",
            name: "Monogrammed Alligator Briefcase",
            description: "Hand-stitched in Milan. Palladium hardware and suede interior.",
            category: "Leather",
            price_cents: 420000, // $4.2k
            currency: "USD",
            stock: 3,
            featured: false,
